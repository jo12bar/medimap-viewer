define(['jquery', 'highcharts', 'socketio'], ($, Highcharts, io) => {
  $(document).ready(() => {
    const chart = new Highcharts.Chart({
      ...
      title: { text: 'CPU Load Average & Memory Usage' },
      ...
      yAxis: [
        {
          title: { text: 'Memory %age' },
          min: 0,
          max: 100,
          plotLines: [{ value: 0, width: 1, colour: '#808800' }],
          opposite: true,
        },

        {
          title: { text: 'LoadAvg' },
          min: 0,
          plotLines: [{ value: 0, width: 1, colour: '#008888', zIndex: 0 }],
        },
      ],
